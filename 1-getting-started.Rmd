...
```{r, include=FALSE, echo=FALSE, fig.show='animate', interval=1/10, message=FALSE, fig.height=5, fig.width=8, aniopts='controls,buttonsize=0.3cm,width=11.5cm', cache=TRUE}
# Not included because wrap=FALSE doesn't work here for some unknown reason
# Latex code that follows only uses the relevant images
fc <- aus_production %>%
  model(ETS(Beer)) %>%
  forecast()
...
\animategraphics[,controls,buttonsize=0.3cm,width=11.5cm]{10}{1-getting-started_files/figure-beamer/unnamed-chunk-2-}{1}{50}
