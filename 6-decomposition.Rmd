...
elecequip %>% autoplot(value, series="Data") +
  autolayer(dcmp, season_adjust, series="Seasonally Adjusted") +
...
```{r x11, eval=FALSE, fig.height=4.5, fig.width=8, warning=FALSE}
...
```{r seats, warning=FALSE, fig.width=8, fig.height=4.5, eval=FALSE}
...
```{r seats-seasadj, echo=FALSE, warning=FALSE, fig.width=9, fig.height=5.5, eval=FALSE}
fit <- elecequip %>% SEATS(value)
autoplot(elecequip, value, series="Data") +
  autolayer(fit, trend, series="Trend") +
  autolayer(fit, season_adjust, series="Seasonally Adjusted") +
  xlab("Year") + ylab("New orders index") +
  ggtitle("Electrical equipment manufacturing (Euro area)") +
