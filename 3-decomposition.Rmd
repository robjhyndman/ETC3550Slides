...
```{r stlwindowanim, echo=FALSE, warning=FALSE, fig.show='animate', interval=1/10, message=FALSE, fig.height=5.35, fig.width=8, aniopts='controls,buttonsize=0.3cm,width=11.5cm', eval=FALSE}
s_windows <- seq(5,55,by=2)
stl_defs <- map(s_windows, function(s_window){
...
\animategraphics[controls,buttonsize=0.3cm,width=11.5cm]{10}{3-decomposition_files/figure-beamer/stlwindowanim-}{1}{100}
