...
```{r stlwindow3, echo=TRUE, warning=FALSE, fig.width=8, fig.height=4}
dcmp <- us_retail_employment %>%
  model(STL(Employed ~ season(window=3), robust=TRUE)) %>%
  components()
autoplot(dcmp) +
  ggtitle("STL decomposition of US retail employment")
```

## STL decomposition
\fontsize{10}{11}\sf

```{r stlwindow5, echo=TRUE, warning=FALSE, fig.width=8, fig.height=4}
dcmp <- us_retail_employment %>%
...
```{r stlwindow7, echo=TRUE, warning=FALSE, fig.width=8, fig.height=4}
dcmp <- us_retail_employment %>%
...
```{r stlwindow11, echo=TRUE, warning=FALSE, fig.width=8, fig.height=4}
dcmp <- us_retail_employment %>%
  model(STL(Employed ~ season(window=11), robust=TRUE)) %>%
  components()
autoplot(dcmp) +
  ggtitle("STL decomposition of US retail employment")
```
...
```{r stlwindow13, echo=TRUE, warning=FALSE, fig.width=8, fig.height=4}
dcmp <- us_retail_employment %>%
  model(STL(Employed ~ season(window=13), robust=TRUE)) %>%
  components()
autoplot(dcmp) +
  ggtitle("STL decomposition of US retail employment")
```
...
```{r stlwindow15, echo=TRUE, warning=FALSE, fig.width=8, fig.height=4}
dcmp <- us_retail_employment %>%
  model(STL(Employed ~ season(window=15), robust=TRUE)) %>%
  components()
autoplot(dcmp) +
  ggtitle("STL decomposition of US retail employment")
```
...
```{r stlwindowinf, echo=TRUE, warning=FALSE, fig.width=8, fig.height=4}
fit <- us_retail_employment %>%
  model(STL(Employed ~ season(window="periodic"), robust=TRUE)) %>%
  components()
autoplot(fit) +
  ggtitle("STL decomposition of US retail employment")
```
