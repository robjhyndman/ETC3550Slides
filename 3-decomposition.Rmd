...
```{r stlwindowanim, echo=FALSE, warning=FALSE, fig.show='animate', interval=1/10, message=FALSE, fig.height=5.35, fig.width=8, aniopts='controls,buttonsize=0.3cm,width=11.5cm'}
