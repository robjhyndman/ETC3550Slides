...
tibble(
  ...
  coord_fixed() +
  guides(fill = "none") +
  annotate("text", label = "ETS models", x = -1.5, y = 1.35, col = cols["ets"], fontface = "bold", size = 6, family = "Source Sans Pro") +
  ...
  annotate("text", label = "ARIMA models", x = 1.5, y = 1.35, col = cols["arima"], fontface = "bold", size = 6, family = "Source Sans Pro") +
