...
\end{block}\fontsize{12}{14}\sf
  ...
  * $\h+= [(h-1)\!\mod~m]+1=$&nbsp;  largest integer not greater than $(h-1)\!\mod~m$. Ensures estimates from the final year are used for forecasting.
...
\begin{block}{Component form}\vspace*{-0.4cm}
    ...
    \end{align*}
\end{block}\fontsize{12}{14}\sf\vspace*{-0.2cm}
...
y_{T+2}         & = \ell_{T+1} + b_{T+1} + \varepsilon_{T+1}\\
                & =
